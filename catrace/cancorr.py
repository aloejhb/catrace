...
def get_comp_pattern_from_list(
    exp_idx, exp_list, pca_dlist, pattern_dlist, cca, comp_kwargs
):
...
def get_comp_pattern_list(exp_list, pca_dlist, pattern_dlist, cca, comp_kwargs):
    comp_pattern_list = [
        get_comp_pattern_from_list(
            k, exp_list, pca_dlist, pattern_dlist, cca, comp_kwargs
        )
